...
<section class="tm-hero tm-band" aria-label="<?php esc_attr_e( 'Featured promotion', 'techmart' ); ?>">
	<div class="tm-container tm-hero__inner">
	...
	<?php
	/**
	 * Compact trust-badges strip, directly under the hero content —
	 * matches the reference design. Reuses the same trust-item
	 ...
	 * Filterable, not Customizer-driven, for the same reason as the
	 * Why Shop items: this is stable structural content, not copy an
	 * admin swaps often.
	 */
	...
	<?php if ( $hero_trust_items ) : ?>
		<div class="tm-hero__trust-strip">
			<div class="tm-container tm-hero__trust-strip-inner">
