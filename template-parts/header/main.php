...
<div class="tm-header__inner tm-container">
	...
	<div class="tm-header__utility">
		<a href="<?php echo esc_url( techmart_get_wishlist_url() ); ?>" class="tm-header__utility-link tm-wishlist-toggle">
		...
		<div class="tm-header__cart-wrapper">
			<a
				...
				class="tm-header__utility-link tm-header__cart-toggle"
				aria-haspopup="true"
				aria-expanded="false"
				aria-controls="tm-mini-cart"
			>
		...
		<a href="<?php echo esc_url( $account_url ); ?>" class="tm-header__utility-link">
			...
			<span class="tm-header__utility-label">
				<?php esc_html_e( 'Sign In', 'techmart' ); ?><br>
